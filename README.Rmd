...
Most of the dots are in the bottom left, this signifies that houses with smaller lot area, are generally cheaper. There are a few outliers though around the bottom right side, meaning that their price is high, but they still dont have a lot of lot area.
```
